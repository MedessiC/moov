...
export function UpdateBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-gold/90 to-gold/70 backdrop-blur-sm animate-in fade-in slide-in-from-top-2 duration-500">
