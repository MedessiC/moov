        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <a href="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <span className="text-primary-foreground text-xs block opacity-80">par MIDEESSI</span>
            </div>
          </a>
          ...
          <div className="hidden lg:block">
            <Button asChild variant="hero" size="lg">
              <a href="/inscription">Rejoindre Moov Famille</a>
            </Button>
          </div>
          ...
          <div className="lg:hidden py-4 border-t border-gold/20 animate-fade-in">
            <div className="flex flex-col gap-2">
              ...
              <Button asChild variant="hero" size="lg" className="mt-4">
                <a href="/inscription" onClick={() => setMobileMenuOpen(false)}>
